...
- **Model to use:** Granite 4:3b Instruct. This "workhorse" model is optimized for your lab hardware (fits comfortably within the RTX 3050's 6 GB VRAM). It excels at structured tasks like RAG (Retrieval-Augmented Generation) and tool-calling, making it ideal for students to build reliable local AI applications.
...
Have your students compare the **IBM Granite 4:3b** model card with the **Llama 3.1 8B** model card.
